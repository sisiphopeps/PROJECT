      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p class="fs-6">
               10338 Ntabesinayi Str, Lower Crossroads<br>
               Philippi East 
               Cape Town 
               7785
            </p>
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p class="fs-6"><i class="fas fa-envelope mr-3"></i> sisiphopepengweni@gmail.com</p>
            <p class="fs-6"><i class="fas fa-phone "></i> +27 63 537 5458</p>
          </div>
          <!-- Grid column -->
          <!-- Grid column -->
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
            <h6 class="text-uppercase mb-4 font-weight-bold">Let's get in touch</h6>
            <!-- Facebook -->
            <a
